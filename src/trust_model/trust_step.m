...
% % --- (OPTIONAL) Diagnostic logging for anomalous values (pre-clipping)  ---
% % --- Kept commented out by default, because it blows up simulation time ---
